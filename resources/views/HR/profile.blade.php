        ...
        <form action="{{route('profileUpdate')}}" method="POST" enctype="multipart/form-data">
            ...
            <table class="recruitment">
                ...
                <tr>
                    <td>
                          <p>Full Name</p>
                          <input type="text" placeholder="First Name" name="fname" value="{{auth()->user()->fname}}">
                ...
                <tr>
                   ...
                   <td> <div class="formdata">
                    <p>Blood Group</p>
                    <input type="text" placeholder="Blood Group" name="blood" value="{{auth()->user()->blood}}">
                  </div>
               </td>
                ...
                <tr>
                    <td colspan="2" >
                        <img src="{{asset('storage/images/'.auth()->user()->image)}}" alt="profile Image" id=preview>
        ...
        <form action="{{route('PasswordUpdate')}}" method="POST">
            ...
            <table class="recruitment">
                ...
                <tr>
                    <td>
                          <p>User Name</p>
                          <input type="text" readonly placeholder="User Name" name="Uname" value="{{auth()->user()->uname}}">
                ...
                <tr>
                     ...
                     <td> <div class="formdata">
                        <p>Password</p>
                        <input type="password" readonly placeholder="User Name" name="Uname" value="{{bcrypt(auth()->user()->password)}}">
                      </div>
                   </td>
